...
/*
 * msg_type: 十进制取值如下：0：透传消息 1：通知. 默认值为0
 * msg_expires: 单位是秒, 0~604800(86400*7)，默认为5小时(18000秒)
 * deploy_status: 取值为：1：开发状态；2：生产状态； 若不指定，则默认设置为生产状态
 * send_time: 指定的实际发送时间，必须在当前时间60s以外，1年以内
 */
...
prototype.pushMsgToSmartTag = function() {
  throw new Error('no RESTful api for pushMsgToSmartTag');
};
...
prototype.queryStatisticMsg = function(callback) {
  throw new Error('no RESTful api for queryStatisticMsg');
};
